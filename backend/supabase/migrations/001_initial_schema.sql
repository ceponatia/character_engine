...
CREATE TABLE settings (
  ...
  mood TEXT, -- Overall atmosphere/mood of the setting
  theme TEXT, -- Genre or theme (romantic, adventure, mystery, etc.)
...
CREATE TABLE locations (
  ...
  details TEXT, -- Additional details, atmosphere, etc.
  
  -- Location metadata
  location_type TEXT DEFAULT 'room', -- 'room', 'building', 'outdoor', 'landmark', 'vehicle'
  ambiance TEXT, -- Mood/atmosphere
  lighting TEXT, -- Lighting conditions
  accessibility TEXT, -- How accessible this location is
...
CREATE TABLE setting_locations (
  ...
  -- Optional: order and role
  order_index INTEGER DEFAULT 0,
  role_in_setting TEXT, -- 'main', 'secondary', 'background'
